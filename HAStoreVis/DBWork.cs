...
namespace HAStoreVis
{
    ...
    internal class DBWork
    {
        ...
        internal static double AverageAgeOfCustomersWhoBoughtPendantOnFebruary14(string v)
        {
            throw new NotImplementedException();
        }

        internal static decimal AverageCheckOnDecember31(string v)
        {
            throw new NotImplementedException();
        }

        internal static int CountCustomersWhoBoughtWatchesIn2023(string v)
        {
            throw new NotImplementedException();
        }
    }
    public static class StoreDatabaseOperations // Название класса может быть любым
    {
        public static int CountCustomersWhoBoughtWatchesIn2023(string _dbname = "Store.db")
        {
            string path = $"Data Source=\"{_dbname}\";";
            string query = @"
...
WHERE pc.Name = 'Часы' AND strftime('%Y', p.PurchaseDate) = '2023';";
        ...
        public static double AverageAgeOfCustomersWhoBoughtPendantOnFebruary14(string _dbname = "Store.db")
        {
            string path = $"Data Source=\"{_dbname}\";";
            string query = @"
...
WHERE pc.Name = 'Кулоны' AND p.PurchaseDate = '2023-02-14';";
        ...
        public static decimal AverageCheckOnDecember31(string _dbname = "Store.db")
        {
            string path = $"Data Source=\"{_dbname}\";";
            string query = @"
